...
const Data = () =>{
    return(
        <div className = "home__data">
            <h1 className="home__title">Prakash Devta
            ...
            <p className="home__description">I am full stack developer with experience in web development, database. 
            Eager to leverage skills in a new environment and grow as a developer.</p>
